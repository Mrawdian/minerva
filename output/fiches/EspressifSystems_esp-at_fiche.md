...
**Problem solved:** ESP-AT 是乐鑫官方基于 ESP-IDF 和 ESP8266-RTOS-SDK 推出的 AT 应用框架，可支持 ESP8266、ESP32、ESP32-S2。ESP-AT 国内镜像仓库。
**How it works:** # ESP-AT
...
**Maturity:** Active (★ 50, 4 forks, updated 2026-09)
